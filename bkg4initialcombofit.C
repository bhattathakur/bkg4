{
  ...
  const char * filename="ROOTFILES/bkg4initial.root"; //access the original histogram
  const char * allhistogramsfile="ROOTFILES/bkg4initial_allhistogram.root"; //Dave the histogram
  char  file_estimated_parameters[]="DATA/bkg4initialestimates.dat"; //file storing the estimated parameters for fit
  char  outputfile[] ="DATA/bkg4initialEnergyerror.dat";
  char initialcanvaspdf[]="PLOT/bkg4initialcanvas.pdf";
  const  int peakNo=23;
  const  int column=6;
